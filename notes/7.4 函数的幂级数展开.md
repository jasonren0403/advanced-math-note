...
4. $(1+x)^m=1+\dfrac{m}{1!}x+{m(m-1)}{2!}x^2+\cdots+\dfrac{m(m-1)\cdots(m-n+1)}{n!}x^n+\cdots,x\in(-1,1)$
...
### 例题
1. 将 $f(x)=e^x$ 展开为 $x$ 的幂级数（麦克老林级数/在 $x=0$ 处展开成泰勒级数）
